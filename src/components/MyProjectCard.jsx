    ...
    return (
        <CardWrapper>
            <CardHeader>
                ...
                <StatusTag color={statusStyle.color} textColor={statusStyle.textColor}>{status}</StatusTag>
            </CardHeader>
            ...
            <CardFooter>
                <OwnerDetails>
                    ...
                    <OwnerName>{dono || 'Dono não informado'}</OwnerName>
                </OwnerDetails>

                <ActionButtons>
                    <IconButton onClick={() => alert('Abrir chat do projeto!')}>
                        <FaCommentDots size={20} /> Chat
                    </IconButton>
                    
                    {isOwner ? (
                        <Botao variant="hab-int" onClick={() => alert('Abrir modal de gerenciamento!')}>
                            <FaCog style={{ marginRight: '5px' }}/> Gerenciar
                        </Botao>
                    ) : (
                        <Botao variant="hab-int" onClick={() => alert('Ver detalhes do projeto!')}>
                            Ver Detalhes
                        </Botao>
                    )}
                </ActionButtons>
